```
certificates_and_certifications/
├── certificates/
|   ├── academic_certificates/
|   |   ├── John Mike Asuncion - 1ST - CPE Fair 2024 - General Engineering and Sciences Quiz Bee.jpg
|   |   └── John Mike Asuncion - The Fundamental Tournament of Calculus 2025.pdf
|   |       
|   ├── edtech/
|   |   └── eskwelabs/
...
|   |       ├── John Mike Asuncion - HR's First AI Tool for Upskilling. Survey Design Support.pdf
...
|   |
|   ├── school_orgs_certificates/
|   |   ├── Google Developer Groups on Campus PUP/
|   |   |   ├── John Mike Asuncion - Creating Analytics Dashboard with Google Sheets and Looker Studio.png
|   |   |   ├── John Mike Asuncion - Pandas - From Basics to Intermediate.png
|   |   |   ├── John Mike Asuncion - PyStart - Functions & Libraries – Python Data Toolkit.png       
|   |   |   └── John Mike Asuncion - PyStart - Getting Started with Python.png
|   |   |
|   |   └── PUP Manila Microsoft Student Community/
|   |        ├── John Mike Asuncion - Get Started with GitHub and GitHub Copilot.png
|   |        └── John Mike Asuncion - Get Started with Python.png
|   |
|   └── z-others/
|       ├── John Mike Asuncion - ROTC - Orientation to NSTP Advocacies Towards Promoting Civic Consciousness.pdf
|       └── John Mike Asuncion - Team Kaizen - Tech Timeout - The Ultimate Spark Rush.jpg
|
├── certifications/
|
└── README.md
